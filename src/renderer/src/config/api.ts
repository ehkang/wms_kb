...
// nx_one 后端地址：统一使用 one.wxnanxing.com
const NX_ONE_HOST = 'https://one.wxnanxing.com'
...
export const API_CONFIG = {
  ...
  // 统一使用 https://one.wxnanxing.com/api
  NX_ONE_BASE_URL: `${NX_ONE_HOST}/api`,

  // 3D模型API完整路径（去掉/download）
  MODEL_3D_URL: `${NX_ONE_HOST}/api/technical/drawing/model3d`,
